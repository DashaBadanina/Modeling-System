   ...
   public class RequestQueue
    {
        ...
        public void Push(RequestForServ NewApp)
        {
            ...
            {
                Statistic.STL[ID] += (Form1.TS - LastChangeTime) * ReqInQ;
                LastChangeTime = Form1.TS;

                NewApp.WasInQueue = true;
                NewApp.WaitTime = Form1.TS;
            ...
            else
            {
                ...
                Form1.Log.Add("Время: " + Form1.TS.ToString() + "; Исключение: очередь переполнена, заявка " + NewApp.ID + " вытолкнута с обслуживания");
            }
        }
